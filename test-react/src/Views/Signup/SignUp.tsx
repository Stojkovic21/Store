...
function SignUp() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const result = await axios.get("http://localhost:5057/customer/all");
  ...
  const onSubmit = async (data: customerDto) => {
    ...
    data.role = "User";
    await axios.post("http://localhost:5057/customer/signup", data);
      ...
      <div className="card">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-3">
            ...
            />
            {errors.ime && <span className="text-danger">*Name is required</span>}
          </div>
          ...
          <div className="mb-3">
            ...
            />
            {errors.prezime && <span className="text-danger" >*Lastname is required</span>}
          </div>
          ...
          <div className="mb-3">
            ...
            />
            {errors.brTel && <span className="text-danger">*Phone number is required</span>}
          </div>
